            ...
            <div className="flex items-stretch justify-center" ref={ref}>
                <motion.div
                    ...
                    <div className="pr-6">
                        ...
                        I’d love to connect! Feel free to reach out for project inquiries, collaboration opportunities, or any questions you might have.
                        </p>
...
const contactData = [
    {
        ...
        info: "tusharminche@gmail.com",
        path: "mailto:tusharminche@gmail.com"
    },
    {
        title: "LinkedIn",
        icon: <FaLinkedin size={24} />,
        info: "@tusharminche",
        path: "https://www.linkedin.com/in/tusharminche/"
    },
    {
        title: "leetcode",
        icon: <SiLeetcode size={24} />,
        info: "@TusharMinche",
        path: "https://leetcode.com/u/TusharMinche/"
    },
];
